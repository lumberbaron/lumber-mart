...
Table: PoT prompting performance with different backend model.
...
Table: Comparison of PoT against contemporary work PaL [gao2022pal].
...
Table: Comparison between PoT and equation generation on three different datasets.
